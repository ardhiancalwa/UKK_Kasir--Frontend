                ...
                <tr>
                  ...
                  <div id="dropdown" class="z-10 hidden fixed bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                      ...
                      <li>
                        <a href="#" onClick={() => this.getUserRole("manajer")} class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Manajer</a>
                      </li>
                      <li>
                        <a href="#" onClick={() => this.getUserRole("admin")} class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Admin</a>
                      </li>
                      <li>
                        <a href="#" onClick={() => this.getUserRole("kasir")} class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Kasir</a>
                      </li>
                    </ul>
                  </div>
                  <th scope="col" class="px-6 py-3">
                ...
                {this.state.user.map((item) => (
                  <tr class="bg-white border-b font-sans dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" key={item.id_user}>
                    ...
                    <td class="px-6 py-4 text-center flex justify-evenly">
                      <a href="#" class="inline-flex font-medium text-blue-600 dark:text-blue-500 hover:underline" onClick={() => this.Edit(item)}>
                        <FaEdit size={18} />
                      </a>
                      <a href="#" class="font-medium text-red-600 dark:text-red-500 hover:underline" onClick={() => this.dropUser(item)}>
                        <MdDelete size={18} />
                      </a>
                    </td>
                  </tr>
